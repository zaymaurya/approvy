...
const FLOWS = {
    defaultFlow: [
        {
            email: "mauryajay67@gmail.com",
            name: "Jay maurya (default 1)",
            title: "Team Lead"
        }
    ],
    HR: [
        {
            email: "mauryajay98@gmail.com",
            name: "HR Lead",
            title: "HR Team Lead"
        }
    ],
...
function App() {
    ...
    this.url = "https://script.google.com/macros/s/AKfycbyH1y0aFJP5Ddudt1Te98jXj7kNl2pt6ewnOm7YHc_G6BAmc49mK4vkanT83V4pBSbb/exec" // IMPORTANT - copy the web app url after deploy
